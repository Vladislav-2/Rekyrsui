...
public class ImprovedCoffeeMachineFullEdition extends AbstractCoffeeMachine{
    ...
    public ImprovedCoffeeMachineFullEdition() {
        super();
    }

    public ImprovedCoffeeMachineFullEdition(int coffee, int water, int milk) {
